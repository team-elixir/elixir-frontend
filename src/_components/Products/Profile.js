...
componentDidUpdate(prevProps) {
    if(this.props.userData.loginName!=="")
    {
        ...
        {
            console.log("ComponentDidUpdate has this value " + this.props.userData.loginName)
             this.props.getUserDetails(this.props.userData.userEmail)
...
display(){
    return (
        <div>
            ...
            {(this.props.userData.loginName=="")?(console.log("Empty")):
            ...
            <h1>Details</h1>
            <p><b>Name :</b>{this.props.userData.userEmail}</p>

            <p><b> Email :</b>  {this.props.userData.loginName}</p>
            {/*({this.props.userData.})*/}
            <p><b>Address: </b>{this.props.userDetails.address}</p>
            <p><b>ContactNum: </b>{this.props.userDetails.contactNum}</p>

        </div>
    );
}
    render() {
        if (this.props.userData.loginName=="") // on page reload(via browser) initiaaly , it's
