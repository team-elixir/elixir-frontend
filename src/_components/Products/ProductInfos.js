        ...
        return (
            <div className="col-md-12">
                <main className="col-sm-9 offset-sm-3 col-md-10 offset-md-1 pt-3">
                    ...
                    <div>
                        <h4 className="text-left">{this.props.data.product.name}<span
                            className="p-view-header-brand"> by {this.props.data.product.brand}</span></h4>
                        <h4 className="text-left"><StarRatingComponent name="rate1" starCount={5}
